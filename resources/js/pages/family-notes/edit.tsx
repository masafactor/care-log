...
export default function FamilyNotesEdit({
    familyNote,
    residents,
    categories,
    statuses,
    ...
    const { data, setData, put, processing, errors } =
        useForm<FamilyNoteForm>({
            resident_id: String(familyNote.resident_id),
            category: familyNote.category,
            title: familyNote.title,
            content: familyNote.content,
            note_date: familyNote.note_date,
            status: familyNote.status,
        });

    const submit = (e: FormEvent) => {
        e.preventDefault();

        put(route('family-notes.update', familyNote.id));
    };
            ...
            <div className="space-y-6 p-6">
                ...
                >
                    ...
                    <div className="flex gap-2">
                        ...
                        <Link
                            href={route('family-notes.show', familyNote.id)}
